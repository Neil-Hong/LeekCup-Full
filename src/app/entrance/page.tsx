  ...
  return (
    <div className="flex flex-col w-full text-center">
      ...
      <div className="statics-container mt-6">
        <Link href="/draw" className="btn">开始抽签<br />Start</Link>
        <Link href="/round16" className="btn">进入第二轮<br />Round 2</Link>
        <Link href="/round3" className="btn">进入第三轮<br />Round 3</Link>
        <Link href="/stats" className="btn">技术统计<br />Stats</Link>
        <Link href="/round4" className="btn">进入第四轮<br />Round 4</Link>
        <Link href="/review" className="btn">赛事回顾<br />Match Review</Link>
      </div>
